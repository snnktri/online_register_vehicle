      ...
      <div className="w-full max-w-4xl bg-white p-8 rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col space-y-4">
          <h1 className="text-xl text-center">
            Fill in the registration details <span className="text-red-500">(Note: Some fields may not be needed for first-time registration)</span>
          </h1>
          ...
          <div>
            <label className="block text-sm font-medium">
              Registration Number <span className="text-red-500">Do not need for first-time registration</span>
            </label>
            <input
              type="text"
